...
const InnovaRules: React.FC = () => {
  return (
    <section className="bg-[#020314] text-white">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold mb-8">Innova Rules and Criteria</h1>
        ...
        <div className="border rounded-lg shadow-md p-6 mb-8">
          ...
          <ol className="list-decimal pl-4 description leading-7">
            <li>Models should incorporate electronic technology.</li>
            <li>Models must include a prototype and video proof of working.</li>
            <li>Participants are free to choose any topic.</li>
            <li>Participants must obey the entry time.</li>
            <li>
              Winners will be determined based on accumulated points throughout
              the competition.
            </li>
            <li>Participants may carry their own extension cable.</li>
